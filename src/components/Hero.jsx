...
const Hero = () => {
    return (
        <div
            className='mt-[4em] relative flex flex-col lg:flex-row overflow-hidden  justify-center lg:justify-between w-full bg-white lg:px-[1.5em]'>
            <div className='flex  flex-col  lg:min-w-[35em] z-30 lg:ml-[7.5em]'>
            <div className='flex flex-col px-[1.56em] lg:px-0'>
                <motion.h1
                initial={{
                x: 0, y: 50, opacity: 0.4}}
                transition={{ delay: .5 }}
                animate={{x:0, y:0, opacity:1}}
                    className='text-black/80 text-center lg:text-start text-3xl  md:text-[2.75em]  font-bold '>Africa in one financial platform
                </motion.h1>
                <motion.h2
                initial={{
                x: -38, y: 0, opacity: 0}}
                transition={{ delay: 1 }}
                animate={{x:0, y:0, opacity:1}}
                    className='mt-[0.75em] text-black/80 text-[1em] md:text-lg text-center lg:text-start font-medium '>
            ...
            <div className='w-full flex items-center justify-center mt-[1.5em] '>
                ...
                transition={{ delay: 1 }}
                    animate={{ x: 0, y: 0, opacity: 1 }}
                    className='w-full flex justify-center lg:justify-start lg:mt-[2em]'>
            ...
            <div className='mt-[2em] lg:min-w-[50em]'>
                <img
                    src={earth}
